...
public final class LocaleManager {
	 ...
	 */
	public static String getCountryTLD(final Context context) {
	 ...
	 */
	public static String getProductSearchCountryTLD(final Context context) {
	 ...
	 * @return The top-level domain to use.
	 */
	public static String getBookSearchCountryTLD(final Context context) {
		return doGetTLD(GOOGLE_BOOK_SEARCH_COUNTRY_TLD, context);
	}

	private static String doGetTLD(final Map<String, String> map,
	 ...
	 */
	public static boolean isBookSearchUrl(final String url) {
